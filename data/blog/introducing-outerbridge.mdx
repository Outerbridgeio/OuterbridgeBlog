---
title: 'Introducing Outerbridge - Web3 Automation'
date: '2022-08-12'
lastmod: '2022-08-12'
tags: ['Announcement']
draft: false
summary: 'Outerbridge is an open source low code/no code workflow automation application, focusing on Web3 automation, allowing you to connect different applications and protocols both on-chain and off-chain.'
images: ['/static/images/outerbridge_1.png']
authors: ['default']
---

![outerbridge-banner](https://outerbridgepage.s3.eu-west-1.amazonaws.com/outerbridge_1.png)
